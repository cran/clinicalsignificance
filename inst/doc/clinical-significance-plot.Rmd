...
For clinical significance analyses employing the HLM method [@Raudenbush.2002], individual trajectories can be plotted as well.
...
Trajectories for the HLM can be colored as well.
...
The HA method [@Hageman.1999] considers a band around the post measurement cutoff, which can be plotted as well.
